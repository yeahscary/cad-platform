...
using (var scope = app.Services.CreateScope())
{
    ...
    if (!db.Tests.Any())
    {
        // Сначала создаём преподавателя-администратора
        var teacher = new CadPlatform.Domain.Entities.User
        {
            Email = "teacher@cad.ru",
        ...
        // Тест 1 — теоретический
        var test1 = new CadPlatform.Domain.Entities.Test
        {
            ...
            Questions = new List<CadPlatform.Domain.Entities.Question>
            {
                ...
                new() {
                    Text       = "Какие команды служат для редактирования объектов?",
        ...
        // Тест 2 — практический с чертежом
        var test2 = new CadPlatform.Domain.Entities.Test
        {
